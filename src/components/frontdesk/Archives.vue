<template>
  <div class="main">
    <div class="wzlxzt">
      <el-tabs style="padding: 10px">
        <el-tab-pane label="📄 文章"> <EssayType /></el-tab-pane>
      </el-tabs>

      <!-- 右边栏目 -->
      <div id="cebian">
        <el-tabs style="padding: 10px">
          <el-tab-pane label="🔥 最近"><Recency /></el-tab-pane>
        </el-tabs>
  ...
  <script setup>
import EssayType from "./EssayType.vue";
const ArticleDrawer = defineAsyncComponent(() => import("./ArticleDrawer.vue"));
const Recency = defineAsyncComponent(() => import("./Recency.vue"));
</script>
<style scoped>
.main {
  width: 100%;
